...
#textchat .inlinerollresult {
  background-color: hsl(0, 0%, 10%) !important;
  border: 2px solid var(--accent-color-dark) !important;
...
.nav.nav-tabs > li.active > a {
  ...
  border-bottom: 2px var(--accent-color) !important;
}
...
.ui-dialog .charsheet .repcontainer .repitem .itemcontrol {
  background-color: hsla(var(--accent-color-h), var(--accent-color-s), calc(var(--accent-color-l) - var(--accent-color-darker-percentage)), 0.4) !important;
  
}

.no-touch .ui-dialog .charsheet .repcontainer.editmode div.repitem:hover .itemcontrol {
  background-color: hsla(var(--accent-color-h), var(--accent-color-s), var(--accent-color-l), 0.4) !important;
}
...
div.sheet-licensecontainer .sheet-container .sheet-body button.btn.ui-draggable:hover {
  color: var(--accent-color-complementary) !important;
}
...
div.sheet-rolltemplate-skill div.sheet-container {
  background: url("https://i.imgur.com/j3dHvU0.png") top left round !important;
}
